<template>
  <div>
    ...
    <el-card>
      <el-col>
        <el-button class="add-btn" type="primary" @click="showAddCateDialog">添加分类</el-button>
      </el-col>
    ...
    <el-dialog
      ...
      <el-form :model="addCateForm" ref="addCateFormRef" label-width="100px" :rules="addCateFormRules">
        ...
        <el-form-item label="父级分类: ">
          <el-cascader expand-trigger="hover" :options="parentCateList" v-model="selectedKeys" @change="parentCateChanged" :props="cascaderProps" clearable change-on-select>
          </el-cascader>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    // 选择项发生变化触发这个函数
    parentCateChanged () {
      // 如果 selectedKeys 数组中的 length 大于0 说明选中了
